...
```json
{
  ...
  "whatsNew": "Corrections de bugs et améliorations des performances.",
...
```json
{
  ...
  "counts": { "name": 5, "subtitle": 9, "promotionalText": 55, "description": 1097, "whatsNew": 16, "keywordBytes": 89 }
}
```
...
```json
{
  ...
  "counts": { "name": 5, "subtitle": 25, "promotionalText": 122, "description": 2280, "whatsNew": 44, "keywordBytes": 73 }
}
```
...
```json
{
  ...
  "whatsNew": "Correções de erros e melhorias de desempenho.",
