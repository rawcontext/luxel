...
struct RecordingSessionPresentationTests {
    ...
    @Test("recording formats elapsed time with animated filled status icon and stop actions")
    func recordingFormatsElapsedTimeWithAnimatedFilledStatusIconAndStopActions() {
