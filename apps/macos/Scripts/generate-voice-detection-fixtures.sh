...
"${FFMPEG}" -nostdin -loglevel error -y -stream_loop 2 -i "${TEMP_DIR}/speech.flac" -t 12 \
...
metadata = {
    "speech-16k-mono.wav": ("prompt", "LibriSpeech dev-clean 1272-128104-0000 repeated to 12 seconds", "CC BY 4.0; LibriVox contribution distributed through LibriSpeech"),
    ...
    "podcast-like-48k-stereo.wav": ("noPrompt", "Repeated LibriSpeech 1272-128104-0000 mixed with deterministic synthetic music", "Speech is CC BY 4.0; music is generated by this repository"),
