...
struct SettingsTests {
    @Test("legacy transcript engine setting is ignored")
    func legacyTranscriptEngineSettingIsIgnored() throws {
        ...
        let dictionary = try #require(encoded as? [String: Any])
        #expect(dictionary["transcriptEnginePreference"] == nil)
    }
}
