...
This file is the checked-in source of truth for Luxel's Mac App Store product-page metadata. It records the verified public listing as of August 22, 2026, the localized text metadata for version 1.3.1, and the localized screenshot gallery derived from the six English App Store masters in `docs/design`. Use the guarded App Store workflows to synchronize the editable App Store Connect version; do not edit the draft independently.
...
```json
{
  ...
  "counts": { "name": 5, "subtitle": 24, "promotionalText": 134, "description": 2338, "whatsNew": 39, "keywordBytes": 88 }
}
```
...
```json
{
  ...
  "whatsNew": "Leistungsverbesserungen und Fehlerbehebungen.",
  ...
  "counts": { "name": 5, "subtitle": 27, "promotionalText": 136, "description": 2476, "whatsNew": 45, "keywordBytes": 74 }
}
```
...
```json
{
  ...
  "whatsNew": "Mejoras de rendimiento y correcciones de errores.",
  ...
  "counts": { "name": 5, "subtitle": 30, "promotionalText": 121, "description": 2390, "whatsNew": 49, "keywordBytes": 77 }
}
```
...
```json
{
  ...
  "whatsNew": "Améliorations des performances et corrections de bugs.",
  ...
  "counts": { "name": 5, "subtitle": 25, "promotionalText": 132, "description": 2539, "whatsNew": 54, "keywordBytes": 78 }
}
```
...
```json
{
  ...
  "whatsNew": "Miglioramenti delle prestazioni e correzioni di bug.",
  ...
  "counts": { "name": 5, "subtitle": 30, "promotionalText": 128, "description": 2477, "whatsNew": 52, "keywordBytes": 72 }
}
```
...
```json
{
  ...
  "counts": { "name": 5, "subtitle": 9, "promotionalText": 55, "description": 1097, "whatsNew": 18, "keywordBytes": 89 }
}
```
...
```json
{
  ...
  "counts": { "name": 5, "subtitle": 12, "promotionalText": 66, "description": 1265, "whatsNew": 14, "keywordBytes": 92 }
}
```
...
```json
{
  ...
  "whatsNew": "Cải thiện hiệu năng và sửa lỗi.",
  ...
  "counts": { "name": 5, "subtitle": 22, "promotionalText": 106, "description": 2146, "whatsNew": 31, "keywordBytes": 70 }
}
```
...
```json
{
  ...
  "counts": { "name": 5, "subtitle": 7, "promotionalText": 53, "description": 822, "whatsNew": 10, "keywordBytes": 86 }
}
```
...
```json
{
  ...
  "whatsNew": "Melhorias de desempenho e correções de erros.",
  ...
  "counts": { "name": 5, "subtitle": 25, "promotionalText": 122, "description": 2280, "whatsNew": 45, "keywordBytes": 73 }
}
```
...
```json
{
  ...
  "counts": { "name": 5, "subtitle": 25, "promotionalText": 110, "description": 2352, "whatsNew": 45, "keywordBytes": 76 }
}
```

## Shared App Review notes

App Review notes are not a localized storefront field. Use the single English value in `docs/app-review/review-notes.txt`, which stays below Apple's 4,000-byte limit and explains how to review version 1.3.1.
